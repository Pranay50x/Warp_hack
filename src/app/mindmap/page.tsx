  ...
  return (
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-[#181C2A] via-[#23263A] to-[#23263A] text-gray-100 pt-8">
        {/* Card */}
        <div className="w-full max-w-3xl rounded-2xl bg-[#23263A] border border-[#2c2f4a] shadow-xl p-8 space-y-10">
          {/* Header */}
          <header className="text-center">
            <h1 className="text-4xl font-extrabold mb-2 text-teal-200 drop-shadow">Mindmap Generator</h1>
